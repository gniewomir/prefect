...
**Operator-side FQDN derivation + stage over on-Host `domains.json` parse:** want-list stays the Host ACME contract; Edge does not learn the Propraetor config-tree layout; Edge Setup alone knows Host want-list data paths.
