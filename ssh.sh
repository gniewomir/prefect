...
# Known flags peel from anywhere; remaining tokens forward to ssh (ADR-0039 rest:).
...
CLI_env=""
CLI_ssh_args=()
cli_operator_parse CLI rest:ssh_args -- "$@" || exit 1
...
host_ssh ${CLI_ssh_args[@]+"${CLI_ssh_args[@]}"}
