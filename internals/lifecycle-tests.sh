...
# Not Acceptance Tests (./test.sh). See lifecycle-tests/README.md.
# Environment: omitted / --env default|test → workspace default; --env <slug> otherwise (ADR-0019).
# Usage: ./internals/lifecycle-tests.sh [--env <slug>] [selector]   e.g. ./lifecycle-test.sh park-apply
...
CASE_DIR="${REPO_ROOT}/internals/lifecycle-tests"
