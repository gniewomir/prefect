...
source "${REPO_ROOT}/internals/host-scripts/lib/edge-front-door-host.sh"
...
EDGE_SETUP="${REPO_ROOT}/internals/host-scripts/lib/edge-setup-host.sh"
ACME_RUN="${REPO_ROOT}/internals/components/edge/acme-run.sh"
ROUTES="${REPO_ROOT}/internals/host-scripts/lib/edge-routes-host.sh"
