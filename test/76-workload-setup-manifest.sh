#!/usr/bin/env bash
# Acceptance Test: thin Manifest + operator Routes/Quadlets (ADR-0024 / #57)
set -euo pipefail
...
mkdir -p "${FIX_DIR}/alpha/routes" "${FIX_DIR}/alpha/quadlets"
...
pass "Workload Setup installs operator Route; thin Manifest; no invented Quadlet"
