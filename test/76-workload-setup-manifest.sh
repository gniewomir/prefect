...
! host_ssh "test -f /var/lib/prefect/components_data/workloads/alpha/interior.conf" \
...
host_ssh "test -f /var/lib/prefect/components_data/workloads/zero/manifest.json" \
